...
namespace BlazorWasmNet6Demo.Server.Migrations
{
    ...
    [Migration("20231202185047_Featured_Products")]
    partial class Featured_Products
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorWasmNet6Demo.Shared.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorWasmNet6Demo.Shared.ProductVariant", b =>
                {
            ...
            modelBuilder.Entity("BlazorWasmNet6Demo.Shared.ProductVariant", b =>
                {
                    b.HasOne("BlazorWasmNet6Demo.Shared.Product", "Product")
                        .WithMany("Variants")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorWasmNet6Demo.Shared.ProductType", "ProductType")
                        .WithMany()
